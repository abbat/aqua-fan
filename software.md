...
* `FAN_SPEED_NOISE_HUMIDITY` - динамическое определение значения `FAN_SPEED_NOISE_MULTIPLER` в зависимости от влажности воздуха (по умолчанию не задано), где 100% влажности соответствует значению основания 10, и основанию 0.1 при влажности менее 1%. При задании опции `FAN_SPEED_NOISE_HUMIDITY` значение опции `FAN_SPEED_NOISE_MULTIPLER` игнорируется. Для работы требуется дополнительный датчик с поддержкой измерения влажности воздуха.
